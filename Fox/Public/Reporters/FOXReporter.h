...
/*! An object conforming to this protocol is able to receive updates
 *  on the current status of a FOXRunner. Reporters may present these
 *  statuses to the user, for example, by printing them to stdout or
 *  writing information about them to a file.
 *
 *  For an example of a concrete implementation, see FOXStandardReporter.
 */
@protocol FOXReporter<NSObject>

/*! A message sent to indicate that the runner is about to begin a run
 ...
 *                    random data 300 times, and this message corresponds to the 299th time that property is tested,
 *                    this parameter will have the value of 298 (not 299 because it is zero-indexed).
 *  @param result The result of the individual test of the property. The status of that result is (of course) a failure,
 *                but it also contains information such as the randomly generated value that caused the property to
 *                fail.
 */
...
/*! A message sent to indicate that the value sent to a property in order to cause it to fail has been shrunk.
 *
 *  @param testNumber The number of the current test of the property. That is, if the property is verified against
 *                    random data 300 times, and this message corresponds to the 299th time that property is tested,
 *                    this parameter will have the value of 298 (not 299 because it is zero-indexed).
 ...
 *  @param result The result of the property test run. The result will obviously indicate that the run has succeeded,
 *                but it also contains information on other aspects of the run, such as the seed used.
 */
 ...
 *
 *  @param result The result of the run, which includes information on whether the run passed or failed.
 */
