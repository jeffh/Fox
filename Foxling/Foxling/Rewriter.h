...
#ifndef __Foxling__rewriter__
#define __Foxling__rewriter__
...
class RewriteBuffer {
  ...
  /// and deletions.
  clang::DeltaTree Deltas;
  clang::RewriteRope Buffer;
public:
  typedef clang::RewriteRope::const_iterator iterator;
  ...
  clang::raw_ostream &write(raw_ostream &Stream) const;
...
public:
  ...
  /// Foxling ADDITION
  std::string getRewrittenText(SourceRange Range, int StartDelta, int EndDelta) const;
