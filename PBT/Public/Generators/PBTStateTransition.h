 ...
 *  Typically each transition represents an "API call" with a set of metadata for PBT to verify
 ...
 *      id<PBTGenerator> generator = [transition generator]
 ...
 *
 *  Since most of the arguments are not explicitly defined internals of PBT, you are free to use any objects
